...
export const SYSTEM_PERMISSIONS: readonly SystemPermissionDefinition[] = [
  {
    code: 'user.read',
    name: 'Xem tài khoản',
    description: 'Xem danh sách và chi tiết tài khoản hệ thống',
  },
  { code: 'user.create', name: 'Tạo tài khoản', description: 'Tạo tài khoản hệ thống mới' },
  {
    code: 'user.update',
    name: 'Cập nhật tài khoản',
    description: 'Cập nhật thông tin hoặc trạng thái tài khoản',
  },
  { code: 'user.delete', name: 'Xóa tài khoản', description: 'Xóa tài khoản khỏi hệ thống' },
  {
    code: 'rbac.manage',
    name: 'Quản lý phân quyền',
    description: 'Quản lý group, permission và user-group assignment',
  },
  ...
  { code: 'member.delete', name: 'Xóa hội viên', description: 'Xóa hội viên' },
  {
    code: 'staff.read',
    name: 'Xem nhân sự',
    description: 'Xem danh sách nhân sự và huấn luyện viên',
  },
  ...
  { code: 'package.read', name: 'Xem gói tập', description: 'Xem danh mục gói tập' },
  {
    ...
    description: 'Tạo, sửa và ngừng kinh doanh gói tập',
  },
  { code: 'subscription.read', name: 'Xem đăng ký gói', description: 'Xem đăng ký gói tập' },
  {
    code: 'subscription.create',
    name: 'Tạo đăng ký gói',
    description: 'Tạo hoặc gia hạn đăng ký gói tập',
  },
  ...
  { code: 'maintenance.read', name: 'Xem bảo trì', description: 'Xem phiếu bảo trì' },
  {
    ...
    description: 'Tạo phiếu bảo trì hoặc báo lỗi thiết bị',
  },
  {
  ...
  { code: 'session.manage', name: 'Quản lý lịch tập', description: 'Tạo, sửa và hủy lịch tập' },
  {
    ...
    name: 'Xem chấm công',
    description: 'Xem lịch sử check-in và check-out',
  },
  {
    code: 'attendance.checkin',
    name: 'Check-in hội viên',
    description: 'Ghi nhận check-in hoặc check-out cho hội viên',
  },
  {
    code: 'attendance.self-checkin',
    name: 'Hội viên tự check-in',
    description: 'Hội viên tự check-in bằng QR',
  },
  { code: 'progress.read', name: 'Xem tiến độ', description: 'Xem chỉ số tiến độ luyện tập' },
  {
    code: 'progress.record',
    name: 'Ghi nhận tiến độ',
    description: 'Ghi nhận chỉ số tiến độ luyện tập',
  },
  ...
  { code: 'feedback.handle', name: 'Xử lý phản hồi', description: 'Tiếp nhận và xử lý phản hồi' },
  {
    ...
    name: 'Xem thông báo',
    description: 'Xem và đánh dấu đã đọc thông báo cá nhân',
  },
  {
    code: 'schedule.read',
    name: 'Xem lịch làm việc',
    description: 'Xem lịch làm việc của nhân sự',
  },
  ...
  {
    code: 'exercise.sync',
    name: 'Đồng bộ catalog bài tập',
    description: 'Chạy và xem đồng bộ ExerciseDB',
  },
  { code: 'workout_plan.create', name: 'Tạo giáo án', description: 'Tạo giáo án tập luyện' },
  {
    code: 'workout_plan.update',
    name: 'Cập nhật giáo án',
    description: 'Cập nhật giáo án tập luyện',
  },
  ...
  {
    code: 'workout_log.update',
    name: 'Cập nhật nhật ký tập',
    description: 'Cập nhật nhật ký buổi tập',
  },
] as const
...
export function validateSystemRbacCatalog(): void {
  ...
  for (const groupName of SYSTEM_GROUP_NAMES) {
    ...
    if (unknownCodes.length > 0) {
      throw new Error(
        `System RBAC mapping for ${groupName} has unknown permissions: ${unknownCodes.join(', ')}`
      )
    }
  }
}
